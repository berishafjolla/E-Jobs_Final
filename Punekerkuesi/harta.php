...
<html>
<head>
 <?php echo '<a href="KerkoPun.php">Prapa</a>'; ?>
...
$(document).ready(function() {
	...
	function map_initialize()
	{
			...
			google.maps.event.addListener(map, 'rightclick', function(event) {
				...
				'<label for="pDesc"><span>Pershkrimi :</span><textarea name="pDesc" class="save-desc" placeholder="Shkruaj adresen" maxlength="150"></textarea></label>'+
				'<label for="pType"><span>Type :</span> <select name="pType" class="save-type"><option value="restaurant">Restaurant</option><option value="bar">Lagje</option>'+
				'<option value="house">Rruge</option></select></label>'+
				'</form>'+
				'</div></p><button name="save-marker" class="save-marker">Ruaj detjaet</button>';
...
<div align="center">Kiko per te vendosur marker</div>
