                  ...
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                        <tr>
                          ...
                          <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Emri i kompanise</strong></div></th>
                          <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Qyteti</strong></div></th>
                          <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style12">Personi kontaktues</div></th>
...
$sql = "select * from punedhenesit where Status='Pending'";
$result = mysql_query($sql,$con);
while($row = mysql_fetch_array($result))
{
$Id=$row['PunedhenesiId'];
$Emri=$row['KompaniaEmri'];
$Qyteti=$row['Qyteti'];
$PersoniKon=$row['PersoniKontaktues'];
...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $PersoniKon;?></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DetajPunedhenes.php?EmpId=<?php echo $Id;?>">Detaj</a></strong></div></td>
                        </tr>
                        <?php
}
